...
from erd import ConstraintMetadata, FieldMetadata, ModelMetadata, RelationshipMetadata
...
class TestFieldMetadata:
    ...
    def test_field_metadata_with_constraints(self):
        ...
        field = FieldMetadata(
            name="email", type_hint="str", constraints=["unique", "not_null"]
        )
    ...
    def test_field_metadata_post_init(self):
        ...
        field = FieldMetadata(name="id", type_hint="int")
...
class TestRelationshipMetadata:
    ...
    def test_relationship_metadata_minimal(self):
        ...
        rel = RelationshipMetadata(
            field_name="owner", target_model="User", relationship_type="many-to-one"
        )
...
class TestConstraintMetadata:
    ...
    def test_constraint_metadata_creation(self):
        ...
        constraint = ConstraintMetadata(
            name="pk_user", type="primary_key", fields=["id"]
        )
    ...
    def test_constraint_metadata_unique(self):
        ...
        constraint = ConstraintMetadata(
            name="uk_user_email", type="unique", fields=["email"]
        )
...
class TestModelMetadata:
    ...
    def test_model_metadata_creation(self):
        ...
        relationships = [
            RelationshipMetadata(
                field_name="items", target_model="Item", relationship_type="one-to-many"
            )
        ]

        constraints = [
            ConstraintMetadata(name="pk_user", type="primary_key", fields=["id"])
        ]
    ...
    def test_model_metadata_has_foreign_keys(self):
        ...
        fields_with_fk = [
            FieldMetadata(name="id", type_hint="uuid.UUID", is_primary_key=True),
            FieldMetadata(name="owner_id", type_hint="uuid.UUID", is_foreign_key=True),
        ]
    ...
    def test_model_metadata_foreign_key_fields_property(self):
        ...
        fields = [
            ...
            FieldMetadata(name="owner_id", type_hint="uuid.UUID", is_foreign_key=True),
            FieldMetadata(
                name="category_id", type_hint="uuid.UUID", is_foreign_key=True
            ),
            FieldMetadata(name="name", type_hint="str"),
        ]
    ...
    def test_model_metadata_to_dict(self):
        ...
        fields = [FieldMetadata(name="id", type_hint="uuid.UUID", is_primary_key=True)]
